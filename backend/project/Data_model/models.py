...
class Course(db.Model):
    ...
    topics_description: Mapped[String] = mapped_column(String(5000), nullable=False)
    topics_description_s: Mapped[String] = mapped_column(String(5000), nullable=False)
    topics_description_f: Mapped[String] = mapped_column(String(5000), nullable=False)
